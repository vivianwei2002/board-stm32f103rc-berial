...
#define MPU3050_I2C hi2c2  // <----

#define MPU3050_ADDR_LOW 0x68
#define MPU3050_ADDR_HIGH 0x69

#define MPU3050_DEV (MPU3050_ADDR_LOW << 1)  // <----
...
#define MPU3050_RANGE_PM250 0  /** Range: +-250 deg/s */
#define MPU3050_RANGE_PM500 1  /** Range: +-500 deg/s */
#define MPU3050_RANGE_PM1000 2 /** Range: +-1000 deg/s */
#define MPU3050_RANGE_PM2000 3 /** Range: +-2000 deg/s */
