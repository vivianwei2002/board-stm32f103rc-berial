...
#define max30102_read_bytes(reg, buff, len)        i2c_read_mem(&MAX30102_I2C, MAX30102_DEV, reg, buff, len)
#define max30102_read_1byte(reg)                   i2c_read_1byte_fast(&MAX30102_I2C, MAX30102_DEV, reg, false)
#define max30102_write_1byte(reg, data)            i2c_write_1byte(&MAX30102_I2C, MAX30102_DEV, reg, data)
#define max30102_read_bit(reg, index)              i2c_read_bit_fast(&MAX30102_I2C, MAX30102_DEV, reg, index, false)
#define max30102_write_bit(reg, index, data)       i2c_write_bit(&MAX30102_I2C, MAX30102_DEV, reg, index, data)
#define max30102_read_bits(reg, start, len)        i2c_read_bits_fast(&MAX30102_I2C, MAX30102_DEV, reg, start, len, false)
#define max30102_write_bits(reg, start, len, data) i2c_write_bits(&MAX30102_I2C, MAX30102_DEV, reg, start, len, data)
