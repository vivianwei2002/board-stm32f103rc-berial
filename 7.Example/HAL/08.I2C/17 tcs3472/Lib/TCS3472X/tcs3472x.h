...
typedef enum {
    ...
    TCS3472X_CMD_TYPE_AUTO_INCREMENT   = 0b10 << 5,  // Auto-increment (block protocol), will provide auto-increment function to read successive bytes. 地址自增（用于连读和连写）
...
#define tcs3472x_read_1byte(reg)                 i2c_read_1byte_fast(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), 0)
#define tcs3472x_write_1byte(reg, data)          i2c_write_1byte(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), data)
#define tcs3472x_read_2byte(reg)                 i2c_read_2byte_lsb_msb_fast(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), 0)
#define tcs3472x_write_2byte(reg, data)          i2c_write_2byte_lsb_msb(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), data)
#define tcs3472x_read_bytes(reg, buff, len)      i2c_read_mem(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), buff, len)
#define tcs3472x_read_bit(reg, idx)              i2c_read_bit_fast(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), idx, 0)
#define tcs3472x_write_bit(reg, idx, data)       i2c_write_bit(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), idx, data)
#define tcs3472x_read_bits(reg, idx, len)        i2c_read_bits_fast(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), idx, len, 0)
#define tcs3472x_write_bits(reg, idx, len, data) i2c_write_bits(&TCS3472X_I2C, TCS3472X_DEV, (uint8_t)(TCS3472X_BIT_CMD | reg), idx, len, data)
